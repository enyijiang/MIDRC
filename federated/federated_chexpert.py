    ...
    for mode in ['train', 'test']:
        for domain in domains:
            ...
            if mode == 'train':
                ...
                train_dataset = ChexpertDataset(os.path.join(constants.CHEXPERT_DATA_DIR, f'chexpert_table_{domain}_{mode}.csv'), args.data_aug_times, transform[mode], n_samples=int(args.n_source_samples//4))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_source_samples', type=int, default=6000)
