...
from datasets.MIDRC import MidrcMLTDataset
...
if __name__ == '__main__':
    ...
    for idx, server in enumerate(states):
        ...
        criterions = [criterion_covid, criterion_age] # , criterion_sex, criterion_age]
        ...
        for i in range(args.num_global_epochs):
            ...
            for idx in range(num_clients):
                ...
                local_models[idx], (loss, acc, auc) = train(args, 'source', local_models[idx], criterions, clients_dls['train'][idx], False, i)
