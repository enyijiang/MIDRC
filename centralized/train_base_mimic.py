...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir', type=str, default='mimic_base')
    parser.add_argument('--iter_idx', type=int, default=0)
    parser.add_argument('--resnet', type=str, default='resnet18')
    parser.add_argument('--load_trained_model', action='store_true')
    parser.add_argument('--model_path', type=str, default=None)
    parser.add_argument('--num_source_epochs', type=int, default=20)
    parser.add_argument('--num_target_epochs', type=int, default=20)
    ...
    source_train = MimicDataset(constants.WHITE_TRAIN_CSV_PATH, args.data_aug_times, 
                                          transform['train'], n_samples=args.n_source_samples)
    source_test = MimicDataset(constants.WHITE_TEST_CSV_PATH, 1, 
                                         transform['test'])
    ...
    #                                   transform['test'])
    target_train = MimicDataset(constants.ASIAN_TRAIN_CSV_PATH, args.data_aug_times, 
                                          transform['train'], n_samples=args.n_target_samples)
    target_test = MimicDataset(constants.ASIAN_TEST_CSV_PATH, args.data_aug_times, 
                                          transform['test'])
