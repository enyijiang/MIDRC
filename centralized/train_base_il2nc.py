...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir', type=str, default='states/base')
    ...
    target_train = MidrcDataset(constants.NC_TRAIN_CSV_PATH, args.data_aug_times, 
                                       transform['train'])
    source_train = MidrcDataset(constants.IL_TRAIN_CSV_PATH, args.data_aug_times, 
                                          transform['train'])
    target_test = MidrcDataset(constants.NC_TEST_CSV_PATH, 1, 
                                      transform['test'])
    source_test = MidrcDataset(constants.IL_TEST_CSV_PATH, 1, 
                                         transform['test'])
